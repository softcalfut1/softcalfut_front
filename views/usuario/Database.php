...
class Database {
    ...
    public function validarUsuario($documento, $pass) {
        $sql = "SELECT u.id, u.documento, u.nombres, u.apellido, u.email, u.id_rol, r.nombre as rol_nombre, r.descripcion as rol_descripcion
                FROM usuario u
                JOIN rol r ON u.id_rol = r.id
                WHERE u.documento = '$documento' AND u.pass = '$pass' AND u.estado = 1"; 
